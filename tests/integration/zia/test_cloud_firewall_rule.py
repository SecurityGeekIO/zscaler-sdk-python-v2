    ...
    def test_firewall_rule(self, fs):
        ...
        try:
            try:
                ...
                created_dst_group = client.zia.firewall.add_ip_destination_group(
                    name=dst_group_name,
            ...
            try:
                ...
                created_src_group = client.zia.firewall.add_ip_source_group(
                    name=src_group_name,
            ...
            try:
                ...
                created_rule = client.zia.firewall.add_rule(
                    name=rule_name,
            ...
            try:
                ...
                retrieved_rule = client.zia.firewall.get_rule(rule_id)
            ...
            try:
                ...
                updated_rule = client.zia.firewall.get_rule(rule_id)
            ...
            try:
                ...
                rules = client.zia.firewall.list_rules()
            ...
            try:
                ...
                if rule_id:
                    delete_status = client.zia.firewall.delete_rule(rule_id)
            ...
            try:
                if dst_group_id:
                    client.zia.firewall.delete_ip_destination_group(dst_group_id)
            except Exception as exc:
                cleanup_errors.append(f"Deleting Destination IP Group failed: {exc}")

            try:
                if src_group_id:
                    client.zia.firewall.delete_ip_source_group(src_group_id)
            except Exception as exc:
