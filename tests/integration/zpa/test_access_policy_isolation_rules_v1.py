...
class TestAccessPolicyIsolationRuleV1:
    ...
    def test_access_policy_isolation_rules_v1(self, fs):
        ...
        try:
            ...
            created_rule = client.policies.add_isolation_rule(
                name=rule_name,
        ...
        try:
            ...
            all_isolation_rules = client.policies.list_rules("isolation")
        ...
        try:
            ...
            updated_rule = client.policies.update_isolation_rule(
                rule_id=rule_id,
