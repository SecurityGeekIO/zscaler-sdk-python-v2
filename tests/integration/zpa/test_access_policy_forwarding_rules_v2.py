...
class TestAccessPolicyForwardingRuleV2:
    ...
    def test_access_policy_forwarding_rules_v2(self, fs):
        ...
        try:
            ...
            all_forwarding_rules = client.zpa.policies.list_rules("client_forwarding")
        ...
        try:
            ...
            updated_rule = client.zpa.policies.update_client_forwarding_rule_v2(
                rule_id=rule_id,
            ...
            if rule_id:
                try:
                    delete_status_rule = client.zpa.policies.delete_rule("client_forwarding", rule_id)
