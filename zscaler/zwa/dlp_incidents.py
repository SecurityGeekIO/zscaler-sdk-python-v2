...
class DLPIncidentsAPI(APIClient):
    ...
    def get_incident_evidence(
        ...
        The evidence link can be used to view and download the XML file with the actual data that triggered the incident.
    ...
    def dlp_incident_search(self, query_params=None, fields=None, time_range=None, **kwargs) -> tuple:
        """
        Filters DLP incidents based on the given time range and the field values.
