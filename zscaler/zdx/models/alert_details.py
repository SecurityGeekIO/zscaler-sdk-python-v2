    ...
    def __init__(self, config=None):
        ...
        if config:
            ...
            self.geolocations = ZscalerCollection.form_list(
                config["geolocations"] if "geolocations" in config else [], str
            )
            self.departments = ZscalerCollection.form_list(
                config["departments"] if "departments" in config else [], str
            )
            self.locations = ZscalerCollection.form_list(
                config["locations"] if "locations" in config else [], str
            )
            ...
            self.geolocations = ZscalerCollection.form_list([], str)
            self.departments = ZscalerCollection.form_list([], str)
            self.locations = ZscalerCollection.form_list([], str)
