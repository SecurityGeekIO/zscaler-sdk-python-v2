...
from zscaler.zia.activate_v1 import ActivationV1API
from zscaler.zia.admin_and_role_management_v1 import AdminAndRoleManagementV1API
from zscaler.zia.apptotal_v1 import AppTotalV1API
from zscaler.zia.audit_logs_v1 import AuditLogsV1API
from zscaler.zia.authentication_settings_v1 import AuthenticationSettingsV1API
from zscaler.zia.device_management_v1 import DeviceManagementV1API
from zscaler.zia.dlp_v1 import DLPV1API
from zscaler.zia.firewall_v1 import FirewallPolicyV1API
from zscaler.zia.forwarding_control_v1 import ForwardingControlV1API
from zscaler.zia.cloudappcontrol_v1 import CloudAppControlV1API
from zscaler.zia.isolation_profile_v1 import IsolationProfileV1API
from zscaler.zia.rule_labels_v1 import RuleLabelsV1API
from zscaler.zia.pac_files_v1 import PacFilesV1API
from zscaler.zia.locations_v1 import LocationsV1API
from zscaler.zia.sandbox_v1 import CloudSandboxV1API
from zscaler.zia.security_v1 import SecurityPolicyV1API
from zscaler.zia.ssl_inspection_v1 import SSLInspectionV1API
from zscaler.zia.traffic_v1 import TrafficForwardingV1API
from zscaler.zia.url_categories_v1 import URLCategoriesV1API
from zscaler.zia.url_filtering_v1 import URLFilteringV1API
from zscaler.zia.users_v1 import UserManagementV1API
from zscaler.zia.web_dlp_v1 import WebDLPV1API
from zscaler.zia.workload_groups_v1 import WorkloadGroupsV1API
from zscaler.zia.zpa_gateway_v1 import ZPAGatewayV1API
...
class ZIAClientHelper(ZIAClient):
    ...
    def ssl_v1(self):
        ...
        """
        return SSLInspectionV1API(self)
    ...
    def users_v1(self):
        ...
        """
        return UserManagementV1API(self)
