...
class EmergencyAccessAPI(APIClient):
    ...
    def list_users(self, **kwargs) -> tuple:
        """
        Returns a list of all configured Emergency Access Users with pagination support.
        ...
        Returns:
            tuple: A tuple containing a list of `EmergencyAccessUser` instances, response object, and error if any.
        """
        ...
        return ([EmergencyAccessUser(user) for user in list_data], response, None)
