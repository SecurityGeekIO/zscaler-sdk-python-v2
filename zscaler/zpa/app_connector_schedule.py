...
class AppConnectorScheduleAPI(APIClient):
    ...
    def get_connector_schedule(self, customer_id=None, **kwargs) -> tuple:
        """
        ...
        result = AppConnectorSchedule(response.get_body())
        return (result, response, None)

    def add_connector_schedule(self, frequency, interval, disabled, enabled, **kwargs) -> tuple:
        """
        ...
        result = AppConnectorSchedule(payload)
        return (result, response, None)

    def update_connector_schedule(self, scheduler_id: str, frequency, interval, disabled, enabled, **kwargs) -> tuple:
        """
