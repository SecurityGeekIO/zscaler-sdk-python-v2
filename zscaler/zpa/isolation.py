...
# class IsolationAPI(APIClient):


#     def list_cbi_banners(self: str) -> Box:
#         """
...
#     def get_cbi_banner(self, banner_id: str) -> Box:
#         """
...
#     def add_cbi_banner(self, name: str, banner: bool, **kwargs) -> Box:
#         """
...
#     def update_cbi_banner(self, banner_id: str, **kwargs) -> Box:
#         """
...
#     def delete_cbi_banner(self, banner_id: str) -> int:
#         """
...
#     def list_cbi_certificates(self: str) -> Box:
#         """
...
#     def get_cbi_certificate(self, certificate_id: str) -> Box:
#         """
...
#     def add_cbi_certificate(self, name, pem: str, **kwargs) -> Box:
#         """
...
#     def update_cbi_certificate(self, certificate_id: str, **kwargs) -> Box:
#         """
...
#     def delete_cbi_certificate(self, certificate_id: str) -> int:
#         """
...
#     def list_cbi_profiles(self, **kwargs) -> BoxList:
#         """
...
#     def get_cbi_profile_by_name(self, name: str):
#         """
...
#     def get_cbi_profile_by_id(self, profile_id: str):
#         """
...
#             >>> print(profile)
#         """
#         profiles = self.list_cbi_profiles()
#         for profile in profiles:
...
#     def list_cbi_zpa_profiles(self, show_disabled=None, scope_id=None) -> Box:
#         """
...
#     def get_cbi_zpa_profile(self, cbi_profile_id: str) -> Box:
#         """
...
#     def list_cbi_regions(self: str) -> Box:
#         """
...
#     def get_cbi_region(self, region_id: str) -> Box:
#         """
