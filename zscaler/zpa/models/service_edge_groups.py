...
class ServiceEdgeGroup(ZscalerObject):
    ...
    def __init__(self, config=None):
        ...
        if config:
            ...
            self.alt_cloud = config["altCloud"]\
            ...
            self.grace_distance_value = config["graceDistanceValue"]\
                if "graceDistanceValue" in config else None
            self.grace_distance_value_unit = config["graceDistanceValueUnit"]\
                if "graceDistanceValueUnit" in config else None
